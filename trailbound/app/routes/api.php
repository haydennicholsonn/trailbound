...
Route::post('/admin/players/{playerId}/timeout', [AdminController::class, 'timeoutPlayer']);
Route::post('/admin/players/{playerId}/ban', [AdminController::class, 'banPlayer']);
Route::post('/admin/players/{playerId}/unban', [AdminController::class, 'unbanPlayer']);
...
Route::post('/inventory/{userItemId}/equip', [InventoryController::class, 'equip']);
Route::get('/loot/daily', [LootBoxController::class, 'daily']);
Route::post('/loot/daily/open', [LootBoxController::class, 'openDaily']);
Route::get('/market', [MarketController::class, 'index']);
Route::post('/market/listings', [MarketController::class, 'listItem']);
Route::post('/market/listings/{listingId}/buy', [MarketController::class, 'buy']);
Route::post('/market/listings/{listingId}/cancel', [MarketController::class, 'cancel']);
...
Route::post('/groups/{groupId}/members/{memberId}/block', [GroupController::class, 'blockMember']);
Route::get('/groups/{groupId}/messages', [GroupController::class, 'messages']);
Route::post('/groups/{groupId}/messages', [GroupController::class, 'send']);
Route::post('/users/{userId}/block', [GroupController::class, 'blockUser']);
Route::delete('/users/{userId}/block', [GroupController::class, 'unblockUser']);
